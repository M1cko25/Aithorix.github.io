...
const handleCreateTask = (newTask) => {
  emit('task-created', props.id, newTask)
  closeModal()
}
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="ml-64 pt-16">
      ...
      <div class="px-6 pb-6 flex gap-6">
        <KanbanColumn v-for="column in columns" :key="column.id" :id="column.id" :title="column.title"
          :tasks="column.tasks" @task-created="addTaskToColumn" />
